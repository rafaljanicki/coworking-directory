...
const OfertaGdanskPage: React.FC = () => {
  const offer = {
    city: 'Gdańsk',
    title: 'Oferta Coworkingowa w Gdańsku',
    description: `
      <p>Witamy w naszym centrum coworkingowym w Gdańsku. Szczegółowe informacje o tej ofercie zostaną wkrótce dodane przez naszego Content Creatora.</p>
    ...
    `,
    images: [
      'https://via.placeholder.com/600x400.png?text=Gdansk+Biuro+1',
      'https://via.placeholder.com/600x400.png?text=Gdansk+Biuro+2',
    ],
    address: 'ul. Przykładowa, Gdańsk',
    phone: '+48 000 000 000',
    email: 'gdansk@biuracoworking.pl',
...
export default OfertaGdanskPage;
