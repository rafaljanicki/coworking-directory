...
const OfertaWarszawaPage: React.FC = () => {
  const offer = {
    city: 'Warszawa',
    title: 'Oferta Coworkingowa w Warszawie',
    description: `
      <p>Witamy w naszym centrum coworkingowym w Warszawie. Szczegółowe informacje o tej ofercie zostaną wkrótce dodane przez naszego Content Creatora.</p>
    ...
    `,
    images: [
      'https://via.placeholder.com/600x400.png?text=Warszawa+Biuro+1',
      'https://via.placeholder.com/600x400.png?text=Warszawa+Biuro+2',
    ],
    address: 'ul. Przykładowa, Warszawa',
    phone: '+48 000 000 000',
    email: 'warszawa@biuracoworking.pl',
      ...
      <div className="container mx-auto px-4 py-8">
        <nav className="mb-4 text-sm text-gray-500" aria-label="Breadcrumb">
          <ol className="list-none p-0 inline-flex">
            ...
            {/* <li className="flex items-center">
              <a href="/oferty" className="hover:underline">Oferty</a> 
              <svg className="fill-current w-3 h-3 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10.293 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L10 12.586l3.293-3.293a1 1 0 011.414 1.414l-4 4z"/></svg>
            </li> */}
            <li>
...
export default OfertaWarszawaPage;
